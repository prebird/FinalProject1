...
namespace FinalProject1_winform
{
    ...
    public partial class PlaceholderNew : TextBox
    {
        string font = "AppleSDGothicNeoM00";
        int fontsize = 10;
        #region Fields

        #region Protected Fields

        protected string _watermark; //The watermark text
        ...
        public PlaceholderNew()
        {
            Initialize();
            this.Font = new Font(font, fontsize);
            this.PlaceHolderFont = new Font(font, fontsize);
            this.PlaceHolderForeColor = Color.DarkGray;
        ...
        private void waterMarkContainer_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.DrawString(this._watermark, waterMarkFont, waterMarkBrush, new PointF(-2f, 1f));//Take a look at that point
